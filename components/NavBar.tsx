...
import { INK, HAIRLINE } from "@/lib/theme";
...
function navLinkClass(active: boolean): string {
  return active
    ? "font-mono text-[11px] font-semibold transition-opacity duration-150"
    : "font-mono text-[11px] transition-opacity duration-150 hover:opacity-50";
}
      ...
      <div className="flex items-center justify-between px-6 py-3 lg:px-10">
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            aria-label="LinkedIn"
            className="-m-3 inline-flex h-11 w-11 items-center justify-center transition-opacity hover:opacity-50"
            style={{ color: INK }}
          >
            <svg
              width="16"
