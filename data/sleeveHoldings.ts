...
export const rothIraHoldings: SleeveHolding[] = [
  ...
  },
  {
    ticker: "IREN",
    company: "IREN",
    portfolioWeightPct: 1.62,
    returnPct: 46.72,
    country: "International",
    marketCap: "Small Cap",
    assetType: "Equity",
    subcategory: "AI / Infrastructure / Energy",
    thesis: "Power-linked digital infrastructure exposure.",
  },
  {
    ticker: "META",
  ...
  },
  {
    ticker: "SATL",
    company: "Satellogic",
    portfolioWeightPct: 1.72,
    returnPct: 27.06,
    country: "Latin America",
    marketCap: "Small Cap",
    assetType: "Equity",
    subcategory: "Space / Earth Observation",
    thesis: "Small-cap satellite and imagery exposure.",
  },
  {
    ticker: "SCHD",
    company: "Schwab U.S. Dividend Equity ETF",
    portfolioWeightPct: 7.10,
    returnPct: 1.14,
    country: "US",
    marketCap: "Large Cap",
    assetType: "ETF",
