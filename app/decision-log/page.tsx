      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
          <div className="flex items-center gap-3">
            ...
            <a href="https://www.linkedin.com/in/isaac-toffel" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-[#111111] transition-opacity hover:opacity-50">
