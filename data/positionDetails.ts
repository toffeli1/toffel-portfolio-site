...
export const positionDetails: Record<string, PositionDetail> = {
  ...
  AVEX: {
    whyIOwnIt:
      "AEVEX Aerospace is a small Roth IRA position, sized modestly because the company is early-stage, less liquid, and requires ongoing monitoring as the business matures. AEVEX builds autonomous unmanned aircraft systems for DoD customers, primarily long-endurance ISR (intelligence, surveillance, and reconnaissance) platforms that can operate in contested environments. Autonomous systems have proven decisive in active conflicts globally, and the DoD's programmatic shift toward attritable and autonomous ISR is accelerating on a timeline that aligns directly with AEVEX's capabilities. The position reflects specific knowledge of the technology, team, and program pipeline alongside the broader DoD autonomous-systems tailwind.",
    whyThisSleeve:
      "AVEX is held in the Roth IRA as a small, long-duration defense technology position. The position is sized modestly because the company is early-stage, less liquid, and requires ongoing monitoring as the business matures. Within the Roth, the role is asymmetric upside exposure rather than core portfolio exposure.",
    longDescription:
